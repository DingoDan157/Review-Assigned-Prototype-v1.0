import svgPaths from "./svg-wecx3te7pe";
...
function CaseList() {
  return (
    <div className="absolute bg-[#fafafb] content-stretch flex flex-col h-[807px] items-start left-[20px] py-[20px] rounded-[4px] top-[134px] w-[262px]" data-name="Case List">
      <Heading />
...
function Accordion() {
  return (
    <div className="absolute h-[473px] left-[302px] rounded-[4px] top-[468px] w-[861px]" data-name="Accordion">
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[4px]" data-name="Client Details 2">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col font-['Noto_Sans:Regular',sans-serif] font-normal gap-[8px] items-start justify-center leading-[0] p-[24px] relative size-full text-[#23262c] text-[14px]">
          <p className="relative shrink-0 whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function Accordion1() {
  return (
    <div className="absolute bg-white left-[302px] rounded-[4px] top-[135px] w-[861px]" data-name="Accordion">
      <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip px-[16px] py-[12px] relative rounded-[inherit] size-full">
        <Header7 />
        <Container1 />
      </div>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-end relative shrink-0 w-full" data-name="Button Group">
      ...
      <div className="bg-[#523eb9] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[4px] shrink-0" data-name="Button">
        <div className="flex flex-col font-['Noto_Sans:Bold',sans-serif] font-bold justify-end leading-[0] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          <p className="leading-[1.65]">Save</p>
        </div>
      </div>
    </div>
  );
...
function Accordion2() {
  return (
    <div className="absolute bg-[#f8fbf1] left-[1205px] rounded-[4px] top-[228px] w-[412px]" data-name="Accordion">
...
function Title4() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Title">
      <div className="flex h-[8px] items-center justify-center relative shrink-0 w-[4.94px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-[4.94px] relative w-[8px]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 4.94">
              <path d={svgPaths.p350de480} fill="var(--fill-0, #23262C)" id="Vector" />
            </svg>
          </div>
...
export default function ReviewAssignedSidebarClosedShowReviewOpen() {
  return (
    <div className="bg-white relative size-full" data-name="Review Assigned / Sidebar Closed / Show Review Open">
      ...
      <CaseList />
      <Accordion />
      <div className="absolute bg-[#eff0f2] content-stretch flex items-center justify-between left-0 overflow-clip px-[32px] py-[12px] top-[961px] w-[1183px]" data-name="Task Bar">
        <ContextHelp />
        <ButtonGroup />
      </div>
      <Accordion1 />
      <div className="absolute bg-white h-[910px] left-[1183px] top-[114px] w-[452px]" data-name="Inline Drawer">
      ...
      <div className="absolute bg-white content-stretch flex gap-[8px] items-center left-[1203px] px-[8px] py-[4px] rounded-[4px] top-[179px]" data-name="Dropdown">
        <div aria-hidden="true" className="absolute border-[#cfd2d9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[4px]" />
        <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[1.65] relative shrink-0 text-[#23262c] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          Quick Clear
        </p>
      ...
      <Accordion2 />
      <div className="absolute bg-white left-[1205px] rounded-[4px] top-[618px] w-[412px]" data-name="Accordion">
        <div className="content-stretch flex items-start overflow-clip px-[16px] py-[12px] relative rounded-[inherit] size-full">
          <Title4 />
        </div>
        <div aria-hidden="true" className="absolute border-[#cfd2d9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
      <div className="absolute bg-white left-[1205px] rounded-[4px] top-[685px] w-[412px]" data-name="Accordion">
        <div className="content-stretch flex items-start overflow-clip px-[16px] py-[12px] relative rounded-[inherit] size-full">
          <Title5 />
        </div>
        <div aria-hidden="true" className="absolute border-[#cfd2d9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[4px]" />

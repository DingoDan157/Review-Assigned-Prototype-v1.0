...
export function SideDrawer({
  ...
  return (
    <div
      className={cn(
        "relative flex shrink-0 flex-col overflow-hidden bg-white dark:bg-[#22272b] border-[#cfd2d9] dark:border-[#38414a] transition-[width,opacity] duration-300 ease-in-out",
      ...
      {isOpen ? (
        <>
          <button
            ...
            className="absolute left-0 top-0 z-10 h-full w-1.5 cursor-col-resize touch-none bg-transparent hover:bg-[#523eb9]/20 active:bg-[#523eb9]/35 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#523eb9]/40"
